...
class _SignupOtpScreenState extends State<SignupOtpScreen> {
  ...
  //ResendOtpController resendOtpController = Get.find();
  SignupOtpController signupOtpController = Get.find();
  var otpNo;
              ...
              children: <Widget>[
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        child:  PinFieldAutoFill(
                          ...
                          codeLength: 6,
                          controller: signupOtpController.otpController,
                ...
                Container(
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: ()async {
                      signupOtpController.otpVerifyUser(context);
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        TextButton(
                          ...
                          onPressed: () {
                            signupOtpController.registerCustomerResendOtp(context);
                            //resendOtpController.registerCustomerResendOtp(context);
                            resendOtp();
